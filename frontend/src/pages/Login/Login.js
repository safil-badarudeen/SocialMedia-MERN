...
function Login() {
  ...
  return (
    ...
    <div className="submainContainer">
        ...
        <input type="email"  className="inputText" onChange = {(e)=>setEmail(e.target.value)}name="" id="" placeholder="email"/>
        <input type="password" className="inputText" onChange= {(e)=>setPassword(e.target.value)} placeholder="************"/>
        <button className='btnForSignUp' onClick={handleClick}>Log In</button>
        <Link to={'/signup'}>
